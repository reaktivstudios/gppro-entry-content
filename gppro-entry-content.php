			...
			'entry-content-cap-color-setup' => array(
				...
				'data'      => array(
					'entry-content-cap-color-text'  => array(
						'label'     => __( 'Base Color', 'gppro-entry-content' ),
						'input'     => 'color',
						'target'    => array( '.entry-content .wp-caption-text', '.entry-content .wp-block-image figcaption' ),
						'builder'   => 'GP_Pro_Builder::hexcolor_css',
						'selector'  => 'color',
					),
					'entry-content-cap-color-link'  => array(
						...
						'sub'       => __( 'Base', 'gppro-entry-content' ),
						'input'     => 'color',
						'target'    => array( '.entry-content .wp-caption-text a', '.entry-content .wp-block-image figcaption a' ),
						'builder'   => 'GP_Pro_Builder::hexcolor_css',
						'selector'  => 'color',
					),
					'entry-content-cap-color-link-hov'  => array(
						...
						'sub'       => __( 'Hover', 'gppro-entry-content' ),
						'input'     => 'color',
						'target'    => array( '.entry-content .wp-caption-text a:hover', '.entry-content .wp-caption-text a:focus', '.entry-content .wp-block-image figcaption a:hover', '.entry-content .wp-block-image figcaption a:focus' ),
						'builder'   => 'GP_Pro_Builder::hexcolor_css',
						'selector'  => 'color',
					),
				),
			...
			'entry-content-cap-appearance-setup'    => array(
				...
				'data'      => array(
					...
					'entry-content-cap-link-dec-hov' => array(
						...
						'sub'       => __( 'Hover', 'gppro-entry-content' ),
						'input'     => 'text-decoration',
						'target'    => array( '.entry-content .wp-caption-text a:hover', '.entry-content .wp-block-image figcaption a:hover' ),
						'builder'   => 'GP_Pro_Entry_Content::link_decorations',
						'selector'  => 'text-decoration',
					),
				),
